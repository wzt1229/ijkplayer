...
#if TARGET_OS_IOS
static const char *kIJKFFRequiredFFmpegVersion = "n4.0-14"; //"ff4.0--ijk0.8.8--20210426--001";
#else
...
- (void)_initWithContent:(NSURL *)aUrl options:(IJKFFOptions *)options glView:(GLView <IJKSDLGLViewProtocol> *)glView
{
    ...
    ijkmp_set_option(_mediaPlayer,IJKMP_OPT_CATEGORY_FORMAT,"protocol_whitelist","ijkhttphook,concat,http,tcp,https,tls,file,bluray,rtmp,rtsp,rtp,udp");
