...
void videotoolbox_ff_free(Ijk_VideoToolBox_Opaque* context)
{
...
int videotoolbox_ff_decode_frame(Ijk_VideoToolBox_Opaque* context)
{
    FFPlayer *ffp = context->ffp;
    VideoState *is = ffp->is;
    Decoder *d = &is->viddec;
...
Ijk_VideoToolBox_Opaque* videotoolbox_ff_create(FFPlayer* ffp, AVCodecContext* avctx)
{
    int ret = 0;
    ...
    int overlay_format = ffp->overlay_format;
    //    //video toolbox 不支持
    //    pixelFormatType = kCVPixelFormatType_16LE565;
    //    pixelFormatType = kCVPixelFormatType_16BE565;
    //    pixelFormatType = kCVPixelFormatType_16LE555;
    ...
    vtctx->output_callback = VTDecoderCallback;
    vtctx->cv_pix_fmt_type = pixelFormatType;
...
fail:
    videotoolbox_ff_free(context_vtb);
    return NULL;
}
